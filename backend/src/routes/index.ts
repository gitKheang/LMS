...
router.get(
  "/books/available-for-loans",
  authenticate,
  booksController.getAvailableBooksForLoans
);
...
router.get(
  "/loans/user/:userId",
  authenticate,
  loansController.getLoansForUser
);
router.get(
  "/admin/loans",
  authenticate,
  requireRole("ADMIN", "STAFF"),
  loansController.getAdminLoans
);
router.post(
  "/admin/loans",
  authenticate,
...
router.post(
  "/admin/loans/:id/remind",
  authenticate,
  requireRole("ADMIN", "STAFF"),
  loansController.sendOverdueReminder
);
router.get(
  "/admin/dashboard",
  authenticate,
  requireRole("ADMIN", "STAFF"),
  loansController.getDashboardStats
);
...
router.post(
  ...
  authenticate,
  requireRole("ADMIN"),
  usersController.createStaffMember
);
router.delete(
  "/admin/users/:id",
  authenticate,
